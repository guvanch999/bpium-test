...
export type BpFieldTypes = 'group' | 'text' | 'number' | 'date' | 'radiobutton' | 'dropdown' | 'checkboxes' | 'stars' | 'progress' | 'contact' | 'user' | 'object' | 'address' | 'file';
/**Описание Отдела*/
...
export type BpFieldsType = (BpFieldID | {
    fieldId: BpFieldID;
    fields?: Record<BpCatalogID, BpFieldsType>;
})[];
/**Простой Запрос */
