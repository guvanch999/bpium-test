...
export interface IBpValues {
    [key: string]: BpValueText | BpValueNumber | BpValueDate | BpValueRadiobutton | BpValueCheckboxes | BpValueDropdown | BpValueProgress | BpValueStars | BpValueContacts | BpValueUsers | BpValueObjects | BpValueFiles | any;
}
/**Текст */
